...
- **📚 Бібліотека промптів** — зберігання, перегляд та завантаження збережених пісень
- **↓ HTML-експорт** — збереження промптів у вигляді красивого автономного HTML-файлу
- **🌐 Двомовний інтерфейс** — перемикання між українською та англійською мовою UI
- **🇫🇷 Французька мова лірики** — нова опція Français у виборі мови лірики
- **v4.0.0 у шапці** — версія застосунку відображається біля назви
- Виправлені баги та покращена стабільність
